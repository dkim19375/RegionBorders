...
import me.dkim19375.regionborders.extension.sendActionBar
import org.bukkit.event.player.PlayerMoveEvent

class ActionBarAction(private val message: String, override val executionType: ExecutionType) : Action {
    override val type: ActionType = ActionType.ACTION_BAR

    override fun execute(event: PlayerMoveEvent) {
        event.player.sendActionBar(message.formatAll(event.player))
    }

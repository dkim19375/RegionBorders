...
class PlayerMsgAction(private val message: String, override val executionType: ExecutionType) : Action {
    override val type: ActionType = ActionType.PLAYER_MSG

    override fun execute(event: PlayerMoveEvent) {
        event.player.chat(message.formatAll(event.player))
    }
